...
func init() {
	...
	setup.Flags().UintVarP(&init_flag_id, "id", "i", 0, "Topology id")
	setup.Flags().StringVarP(&init_flag_config, "config", "c", "../config/config.json", "The path of config.json. Default is ../config/config.json ")
